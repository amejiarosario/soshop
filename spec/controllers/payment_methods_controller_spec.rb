  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved payment_method as @payment_method" do
        ...
        post :create, {:payment_method => { "user" => "invalid value" }}, valid_session
        assigns(:payment_method).should be_a_new(PaymentMethod)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested payment_method" do
        ...
        PaymentMethod.any_instance.should_receive(:update).with({ "user" => "" })
        put :update, {:id => payment_method.to_param, :payment_method => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the payment_method as @payment_method" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        PaymentMethod.any_instance.stub(:save).and_return(false)
        put :update, {:id => payment_method.to_param, :payment_method => { "user" => "invalid value" }}, valid_session
        assigns(:payment_method).should eq(payment_method)
      end
