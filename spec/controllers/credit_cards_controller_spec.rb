  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved credit_card as @credit_card" do
        ...
        post :create, {:credit_card => { "first_name" => "invalid value" }}, valid_session
        assigns(:credit_card).should be_a_new(CreditCard)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested credit_card" do
        ...
        CreditCard.any_instance.should_receive(:update).with({ "first_name" => "MyString" })
        put :update, {:id => credit_card.to_param, :credit_card => { "first_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the credit_card as @credit_card" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        CreditCard.any_instance.stub(:save).and_return(false)
        put :update, {:id => credit_card.to_param, :credit_card => { "first_name" => "invalid value" }}, valid_session
        assigns(:credit_card).should eq(credit_card)
      end
